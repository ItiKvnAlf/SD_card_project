...
`timescale 1 ps / 1 ps
module SD_CARD_mm_interconnect_1 (
	...
	wire   [7:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> sd_clk_s1_agent:cp_channel
	...
	wire   [7:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> sd_cmd_s1_agent:cp_channel
	...
	wire   [7:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> sd_dat_s1_agent:cp_channel
	...
	wire  [11:0] ledg_s1_agent_m0_address;                                                       // ledg_s1_agent:m0_address -> ledg_s1_translator:uav_address
	...
	wire  [86:0] ledg_s1_agent_rf_source_data;                                                   // ledg_s1_agent:rf_source_data -> ledg_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] ledg_s1_agent_rsp_fifo_out_data;                                                // ledg_s1_agent_rsp_fifo:out_data -> ledg_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                          // cmd_mux_003:src_valid -> ledg_s1_agent:cp_valid
	wire  [85:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> ledg_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                          // ledg_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> ledg_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                  // cmd_mux_003:src_startofpacket -> ledg_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                    // cmd_mux_003:src_endofpacket -> ledg_s1_agent:cp_endofpacket
	...
	wire  [85:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> ledr_s1_agent:cp_data
	...
	wire  [85:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> key_s1_agent:cp_data
	...
	wire         cmd_mux_006_src_valid;                                                          // cmd_mux_006:src_valid -> cpu_reset_n_s1_agent:cp_valid
	wire  [85:0] cmd_mux_006_src_data;                                                           // cmd_mux_006:src_data -> cpu_reset_n_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                          // cpu_reset_n_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                        // cmd_mux_006:src_channel -> cpu_reset_n_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                  // cmd_mux_006:src_startofpacket -> cpu_reset_n_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                    // cmd_mux_006:src_endofpacket -> cpu_reset_n_s1_agent:cp_endofpacket
	...
	wire  [85:0] cmd_mux_007_src_data;                                                           // cmd_mux_007:src_data -> timer_0_s1_agent:cp_data
	...
	wire         ledg_s1_agent_rp_valid;                                                         // ledg_s1_agent:rp_valid -> router_004:sink_valid
	wire  [85:0] ledg_s1_agent_rp_data;                                                          // ledg_s1_agent:rp_data -> router_004:sink_data
	wire         ledg_s1_agent_rp_ready;                                                         // router_004:sink_ready -> ledg_s1_agent:rp_ready
	wire         ledg_s1_agent_rp_startofpacket;                                                 // ledg_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         ledg_s1_agent_rp_endofpacket;                                                   // ledg_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [85:0] ledr_s1_agent_rp_data;                                                          // ledr_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [85:0] key_s1_agent_rp_data;                                                           // key_s1_agent:rp_data -> router_006:sink_data
	...
	wire         cpu_reset_n_s1_agent_rp_valid;                                                  // cpu_reset_n_s1_agent:rp_valid -> router_007:sink_valid
	wire  [85:0] cpu_reset_n_s1_agent_rp_data;                                                   // cpu_reset_n_s1_agent:rp_data -> router_007:sink_data
	wire         cpu_reset_n_s1_agent_rp_ready;                                                  // router_007:sink_ready -> cpu_reset_n_s1_agent:rp_ready
	wire         cpu_reset_n_s1_agent_rp_startofpacket;                                          // cpu_reset_n_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         cpu_reset_n_s1_agent_rp_endofpacket;                                            // cpu_reset_n_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [85:0] timer_0_s1_agent_rp_data;                                                       // timer_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [7:0] router_src_channel;                                                             // router:src_channel -> mm_clock_crossing_bridge_m0_limiter:cmd_sink_channel
	...
	wire   [7:0] mm_clock_crossing_bridge_m0_limiter_cmd_src_channel;                            // mm_clock_crossing_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [7:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> mm_clock_crossing_bridge_m0_limiter:rsp_sink_channel
	...
	wire   [7:0] mm_clock_crossing_bridge_m0_limiter_rsp_src_channel;                            // mm_clock_crossing_bridge_m0_limiter:rsp_src_channel -> mm_clock_crossing_bridge_m0_agent:rp_channel
	...
	wire   [7:0] mm_clock_crossing_bridge_m0_limiter_cmd_valid_data;                             // mm_clock_crossing_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire         sd_clk_s1_agent_rdata_fifo_src_valid;                                           // sd_clk_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] sd_clk_s1_agent_rdata_fifo_src_data;                                            // sd_clk_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         sd_clk_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter:in_0_ready -> sd_clk_s1_agent:rdata_fifo_src_ready
	...
	wire         sd_cmd_s1_agent_rdata_fifo_src_valid;                                           // sd_cmd_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] sd_cmd_s1_agent_rdata_fifo_src_data;                                            // sd_cmd_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         sd_cmd_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_001:in_0_ready -> sd_cmd_s1_agent:rdata_fifo_src_ready
	...
	wire         sd_dat_s1_agent_rdata_fifo_src_valid;                                           // sd_dat_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] sd_dat_s1_agent_rdata_fifo_src_data;                                            // sd_dat_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         sd_dat_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_002:in_0_ready -> sd_dat_s1_agent:rdata_fifo_src_ready
	...
	wire         ledg_s1_agent_rdata_fifo_src_valid;                                             // ledg_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] ledg_s1_agent_rdata_fifo_src_data;                                              // ledg_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         ledg_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_003:in_0_ready -> ledg_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                              // avalon_st_adapter_003:out_0_valid -> ledg_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                               // avalon_st_adapter_003:out_0_data -> ledg_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                              // ledg_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                              // avalon_st_adapter_003:out_0_error -> ledg_s1_agent:rdata_fifo_sink_error
	...
	wire         cpu_reset_n_s1_agent_rdata_fifo_src_valid;                                      // cpu_reset_n_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] cpu_reset_n_s1_agent_rdata_fifo_src_data;                                       // cpu_reset_n_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         cpu_reset_n_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> cpu_reset_n_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                              // avalon_st_adapter_006:out_0_valid -> cpu_reset_n_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                               // avalon_st_adapter_006:out_0_data -> cpu_reset_n_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                              // cpu_reset_n_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                              // avalon_st_adapter_006:out_0_error -> cpu_reset_n_s1_agent:rdata_fifo_sink_error
	...
	SD_CARD_mm_interconnect_1_router router (
	...
	SD_CARD_mm_interconnect_1_router_001 router_001 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_002 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_003 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_004 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_005 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_006 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_007 (
	...
	SD_CARD_mm_interconnect_1_router_001 router_008 (
	...
	SD_CARD_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                                 //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                 //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SD_CARD_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	SD_CARD_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                 // in_clk_0.clk
		.in_rst_0_reset (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cpu_reset_n_s1_agent_rdata_fifo_src_data),                      //     in_0.data
		.in_0_valid     (cpu_reset_n_s1_agent_rdata_fifo_src_valid),                     //         .valid
		.in_0_ready     (cpu_reset_n_s1_agent_rdata_fifo_src_ready),                     //         .ready
